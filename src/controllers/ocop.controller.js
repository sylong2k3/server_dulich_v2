...
class OcopController {
  ...
  static getBySpotId = asyncHandler(async (req, res) => OK(res, 'Danh sách sản phẩm OCOP theo điểm du lịch', await OcopService.getAll({ ...req.query, spot_id: req.params.id }, { user: req.user })));
