...
class GovernanceRepository {
    ...
    `;
        ...
        return {
            summary: {
                service_count: Number(operational.service_count || 0),
                active_service_count: Number(operational.active_service_count || 0),
                linked_spot_count: Number(operational.linked_spot_count || 0),
                tour_count: Number(operational.tour_count || 0),
                active_tour_count: Number(operational.active_tour_count || 0),
                listed_tour_value_vnd: Number(operational.listed_tour_value_vnd || 0),
                listed_tour_capacity: Number(operational.listed_tour_capacity || 0),
                ocop_count: Number(operational.ocop_count || 0),
                active_ocop_count: Number(operational.active_ocop_count || 0),
                avg_ocop_stars: Number(operational.avg_ocop_stars || 0),
                listed_ocop_value_vnd: Number(operational.listed_ocop_value_vnd || 0),
                rating_count: Number(operational.rating_count || 0),
                rating_avg: Number(operational.rating_avg || 0),
                voucher_count: Number(operational.voucher_count || 0),
                active_voucher_count: Number(operational.active_voucher_count || 0),
                voucher_used_count: Number(operational.voucher_used_count || 0),
                current_visitors: Number(operational.current_visitors || 0),
                avg_capacity_pct: Number(operational.avg_capacity_pct || 0),
                capacity_alert_count: Number(operational.capacity_alert_count || 0),
                report_count: Number(reported.report_count || 0),
                reported_revenue_vnd: Number(reported.total_revenue_vnd || 0),
                reported_bookings: Number(reported.total_bookings || 0),
                reported_visitors: Number(reported.total_visitors || 0),
            },
            reported_metrics: {
                total_revenue_vnd: Number(reported.total_revenue_vnd || 0),
                total_bookings: Number(reported.total_bookings || 0),
                total_visitors: Number(reported.total_visitors || 0),
                avg_capacity_pct: Number(reported.avg_capacity_pct || 0),
                report_count: Number(reported.report_count || 0),
            ...
            revenue_trend: trendRes.rows.map(row => ({
                period: row.period,
                revenue_vnd: Number(row.revenue_vnd || 0),
                bookings: Number(row.bookings || 0),
                visitors: Number(row.visitors || 0),
            })),
            capacity_alerts: capacityRes.rows.map(row => ({
                ...row,
                capacity_pct: row.capacity_pct ? Number(row.capacity_pct) : null,
            })),
        };
    }
